/**
 * Vórtex Recover Advanced v7.5.0
...
(function() {
  ...
  function exportToTXT() {
    ...
    const txt = `Vórtex Recover - Exportado em ${new Date().toLocaleString('pt-BR')}\nTotal: ${filtered.length} mensagens\n${'═'.repeat(50)}\n\n${lines.join('\n\n')}`;
  ...
  function exportToPDF() {
    ...
    const html = `
      ...
      <html>
      <head>
        <title>Vórtex Recover - Export</title>
        <style>
