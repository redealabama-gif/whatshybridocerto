/**
 * Axion - Sistema de Onboarding Premium v4.0
    ...
    constructor() {
        ...
        this.steps = [
            ...
            // ========== CONCLUSÃO ==========
            {
                ...
                description: 'Agora você conhece todas as funcionalidades do Axion. Explore e potencialize seu WhatsApp!',
                icon: '🎯',
                shortcuts: [
        ...
        return `
            ...
            <div class="whl-tour-panel-mock">
                <div class="panel-mock-header">
                    <span class="panel-mock-logo">🟢 Axion</span>
                </div>
        ...
        return `
            ...
            <div class="whl-tour-header-mock">
                <div class="header-mock-left">
                    ...
                    <span class="header-mock-title">Axion</span>
                </div>
    ...
    showCompletionToast() {
        ...
        toast.innerHTML = `
            ...
            <div class="toast-content">
                ...
                <p>Você está pronto para usar o Axion.</p>
            </div>
