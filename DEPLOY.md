# Vórtex Pro — Guia de Deploy em Produção
...
Da sua máquina local (onde você baixou o zip do Vórtex):
...
crontab -e
# Adicione:
*/15 * * * * /opt/whatshybrid/deploy/scripts/health.sh > /tmp/health.log 2>&1 || mail -s "Vórtex: Health check FALHOU" voce@email.com < /tmp/health.log
```
