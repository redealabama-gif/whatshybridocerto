...
O Sistema de Escalonamento e SLA do Axion é uma solução completa para gerenciamento de atendimento humano, com tracking de SLA, fila priorizada de tickets, regras configuráveis, e métricas detalhadas.
...
Para mais informações ou suporte, consulte a documentação principal do Axion.
