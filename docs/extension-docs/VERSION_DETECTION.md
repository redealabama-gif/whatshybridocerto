...
O sistema de detecção de versão do WhatsApp Web foi implementado para garantir compatibilidade contínua da extensão Vórtex com diferentes versões do WhatsApp Web. O sistema detecta automaticamente a versão em uso e adapta os seletores DOM conforme necessário.
